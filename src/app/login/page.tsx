    ...
    <main className="login-page">
      ...
      <section className="signup-prompt">
        ...
        <div className="signup-actions">
          <button className={`signup-button ${signupType === "customer" ? "signup-selected" : ""}`} onClick={() => setSignupType("customer")}><UserRound aria-hidden="true" /><span>As a Customer</span></button>
          <button className={`signup-button ${signupType === "cook" ? "signup-selected" : ""}`} onClick={() => setSignupType("cook")}><ChefHat aria-hidden="true" /><span>Register as a Cook</span></button>
        </div>
